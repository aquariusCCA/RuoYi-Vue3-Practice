...
export const handlers = [
  ...
  http.get(`${BASE_URL}/system/user/list?pageNum=1&pageSize=10&params%5BbeginTime%5D=2025-05-01&params%5BendTime%5D=2025-05-31&mode=test`, mockResolver),
  ...
  http.get(`${BASE_URL}/system/role/list?pageNum=1&pageSize=10&mode=test`, mockResolver),
  http.get(`${BASE_URL}/system/role/list?pageNum=1&pageSize=10&roleName=%E8%B6%85%E7%BA%A7%E7%AE%A1%E7%90%86%E5%91%98&mode=test`, mockResolver),
  http.get(`${BASE_URL}/system/role/list?pageNum=1&pageSize=10&roleKey=admin&mode=test`, mockResolver),
  http.get(`${BASE_URL}/system/role/list?pageNum=1&pageSize=10&status=0&mode=test`, mockResolver),
  http.get(`${BASE_URL}/system/role/list?pageNum=1&pageSize=10&params%5BbeginTime%5D=2025-05-01&params%5BendTime%5D=2025-05-31&mode=test`, mockResolver),
  http.get(`${BASE_URL}/system/role/treeselect?mode=test`, mockResolver),
  http.post(`${BASE_URL}/system/role`, mockResolver),
  http.put(`${BASE_URL}/system/role/changeStatus`, mockResolver),
  http.get(`${BASE_URL}/system/menu/roleMenuTreeselect/1?mode=test`, mockResolver),
  http.get(`${BASE_URL}/system/role/1?mode=test`, mockResolver),
  http.put(`${BASE_URL}/system/role`, mockResolver),
  http.delete(`${BASE_URL}/system/role/1`, mockResolver),
];
